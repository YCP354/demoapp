...
public abstract class DrvRuntime {
    ...
    public static ProcessSessionKt a(String[] strArr, String[] strArr2) {
        ...
        return new ProcessSessionKt(drvRuntimeC, drvRuntimeC.procExec(strArr, strArr3, file.getAbsolutePath(), iArr), iArr);
    }
